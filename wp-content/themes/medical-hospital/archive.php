                                ...
                                <div class="navigation">
                                    <?php
                                        ...
                                        the_posts_pagination( array(
                                            'prev_text'          => __( 'Previous page', 'medical-hospital' ),
                                            'next_text'          => __( 'Next page', 'medical-hospital' ),
                                            'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'medical-hospital' ) . ' </span>',
                                        ) );
                                    ?>
